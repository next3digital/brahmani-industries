...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Blog" style="width: 100%">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.blog.fields.main_image') }}
                    </th>
                    <th>
                        {{ trans('cruds.blog.fields.gallary') }}
                    </th>
                    <th>
                    ...
                    <th>
                        {{ trans('cruds.blog.fields.sort_description') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
{ data: 'gallary', name: 'gallary', sortable: false, searchable: false },
