    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $productCategory->meta_title) }}">
...
<script>
    ...
    init: function () {
@if(isset($productCategory) && $productCategory->getFirstMedia('image'))
      var file = {!! json_encode($productCategory->getFirstMedia('image')) !!}
