            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($productCategory->getFirstMedia('image'))
                                <a href="{{ $productCategory->getFirstMedia('image')->getUrl() }}" target="_blank" style="display: inline-block">
                                    <img src="{{ $productCategory->getFirstMedia('image')->getUrl('thumb') }}">
                                </a>
                            @endif
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" disabled="disabled" {{ $productCategory->is_active ? 'checked' : '' }}>
                        </td>
                    </tr>
                </tbody>
            </table>
