...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa']], function () {
    ...
    // Asset Management
    Route::delete('asset-managements/destroy', 'AssetManagementController@massDestroy')->name('asset-managements.massDestroy');
    Route::post('asset-managements/media', 'AssetManagementController@storeMedia')->name('asset-managements.storeMedia');
    Route::post('asset-managements/ckmedia', 'AssetManagementController@storeCKEditorImages')->name('asset-managements.storeCKEditorImages');
    Route::resource('asset-managements', 'AssetManagementController');
});
